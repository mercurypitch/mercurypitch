...
export const DIALS: readonly Dial[] = [
  ...
  // ---- the break, as a timeline from the crack -----------------------
  {
    group: 'impact',
    key: 'hitstopSeconds',
    label: 'Hitstop',
    does: 'How long the broken glass holds still after the crack, before it flies.',
    min: 0,
    max: 0.3,
    step: 0.01,
    unit: 's',
  },
  {
    ...
    key: 'slowScale',
    label: 'Slow motion',
    does: 'How fast the break is seen to run just after the hitstop. 1 is no slow motion.',
    min: 0.1,
    max: 1,
    step: 0.05,
    unit: 'x',
  ...
  {
    group: 'impact',
    key: 'slowUntilSeconds',
    label: 'Slow until',
    does: 'Seconds after the crack when the ramp back to full speed starts.',
    min: 0.05,
    max: 1.5,
    step: 0.01,
    unit: 's',
  ...
  {
    group: 'impact',
    key: 'rampUntilSeconds',
    label: 'Full speed by',
    does: 'Seconds after the crack by which the break runs at full speed again.',
    min: 0.05,
    max: 2,
    step: 0.01,
    unit: 's',
  },
  {
    ...
    key: 'shakeSeconds',
    label: 'Shake length',
    does: 'How long the camera shakes. It fades as the square of what is left of it.',
    min: 0,
    max: 1.5,
    step: 0.02,
    unit: 's',
  },
  {
    ...
    key: 'shakeDegrees',
    label: 'Shake',
    does: 'How far the camera turns at the crack, in degrees. Zero is no shake.',
    min: 0,
    max: 4,
    step: 0.05,
    unit: '°',
  ...
  {
    group: 'impact',
    key: 'shakeRollDegrees',
    label: 'Shake roll',
    does: 'How far the camera rolls at the crack, in degrees.',
    min: 0,
    max: 5,
    step: 0.05,
    unit: '°',
  },
  {
    ...
    key: 'shakeHz',
    label: 'Shake speed',
    does: 'How fast the shake wobbles. Low is a sway, high is a rattle.',
    min: 2,
    max: 40,
    step: 1,
    unit: ' Hz',
  },
  {
    ...
    key: 'burstSeconds',
    label: 'Soft burst',
    does: 'How long the picture drops to the burst resolution while the glass flies.',
    min: 0,
    max: 3,
    step: 0.05,
    unit: 's',
  },
  {
    group: 'impact',
    key: 'burstPixelRatio',
    label: 'Burst resolution',
    does: 'Pixel ratio during the burst. At 1.5 or more there is no drop at all.',
    min: 0.5,
    max: 1.5,
    step: 0.05,
    unit: 'x',
  },
  {
    group: 'impact',
    key: 'tap1Seconds',
    label: 'First light tap',
    does: 'When the first of the three light taps comes, seconds after the crack.',
    min: 0,
    max: 1.5,
    step: 0.01,
    unit: 's',
  },
  {
    group: 'impact',
    key: 'tap2Seconds',
    label: 'Second light tap',
    does: 'When the second light tap comes, seconds after the crack.',
    min: 0,
    max: 1.5,
    step: 0.01,
    unit: 's',
  },
  {
    group: 'impact',
    key: 'tap3Seconds',
    label: 'Third light tap',
    does: 'When the last light tap comes, seconds after the crack.',
    min: 0,
    max: 1.5,
    step: 0.01,
    unit: 's',
