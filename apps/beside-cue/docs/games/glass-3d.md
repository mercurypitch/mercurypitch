...
| 2     | Standing Wave Chamber A/B/C, the harmonic ladder HUD, the comedy fall                        | The three chambers are playable end to end and scored. **Planned in detail in `standing-wave-chamber.md`** (2026-09-03), which also carries the follow-ups from device testing |
