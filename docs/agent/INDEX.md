...
| `sidebar` | [sidebar-registry.ts](../../src/features/sidebar/sidebar-registry.ts) | 750 | ── Sidebar panel registry One AppSidebar shell; WHAT it shows is this file's decision, per tab. |
