...
| `guitar-night` | [useGuitarNightSongController.ts](../../src/features/guitar-night/useGuitarNightSongController.ts) | 1.5k | Guitar Night song controller owns lazy library loading, URL state, and backing leases. |
