...
| `sing-room` | [sing-room-store.ts](../../src/features/sing-room/sing-room-store.ts) | 3.5k | The Sing room's state, held where the room is not AT MODULE SCOPE, and that is the whole point. |
