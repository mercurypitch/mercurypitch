...
| `guitar-night` | [useGuitarNightScoreRoomController.ts](../../src/features/guitar-night/useGuitarNightScoreRoomController.ts) | 9.1k | The score room rehearses an authored tab on its own clock, with no separated song. |
