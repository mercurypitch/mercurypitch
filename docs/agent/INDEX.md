...
| `drum-night` | [index.ts](../../src/features/drum-night/session/index.ts) | 25.7k | Drum Night session boundary — import, score, kit, and evidence coaching. |
...
| `guitar` | [guitar-backing-transport.ts](../../src/features/guitar/backing/guitar-backing-transport.ts) | 4.3k | Guitar backing transport keeps separated stems on one route-owned Web Audio clock. |
...
| `play-along` | [useBandPreparationController.ts](../../src/features/play-along/useBandPreparationController.ts) | 2.9k | Shared band preparation controller owns preflight, cancellation, progress, and restaging. |
...
| `routing` | [useHashRouter.ts](../../src/features/routing/useHashRouter.ts) | 350 | useHashRouter — binds the URL hash to app state, both directions The app has no file-system router. |
...
| Module | Entry point | LOC | What it is |
|---|---|---|---|
| `guitar` | [guitar-phrase-review.ts](../../src/lib/guitar/guitar-phrase-review.ts) | 6.3k | Guitar phrase review — evidence-bounded comparison of one take with one pinned score range. |
...
| File | LOC |
|---|---|
| [src/components/StemMixer.tsx](../../src/components/StemMixer.tsx) | 7.9k |
| [src/lib/piano-roll.ts](../../src/lib/piano-roll.ts) | 6.0k |
| [src/features/drum-night/DrumNightApp.tsx](../../src/features/drum-night/DrumNightApp.tsx) | 4.4k |
...
| [src/features/play-along/stem-mix-engine.ts](../../src/features/play-along/stem-mix-engine.ts) | 1.3k |
...
| [src/features/drum-night/audio/drum-kit-player.ts](../../src/features/drum-night/audio/drum-kit-player.ts) | 1.2k |
