...
| `stem-mixer` | [useStemMixerLyricsController.ts](../../src/features/stem-mixer/useStemMixerLyricsController.ts) | 13.2k | StemMixer Lyrics Controller — lyrics/LRC gen/blocks state + actions |
...
| `playback` | [usePlaybackController.ts](../../src/features/playback/usePlaybackController.ts) | 1.3k | usePlaybackController — the Singing tab's transport Start/stop/seek across the three playback modes (free practice, session, backing track). |
...
| `routing` | [useTabNavigationController.ts](../../src/features/routing/useTabNavigationController.ts) | 500 | useTabNavigationController — Tab navigation, swipe gestures & transition cleanup Encapsulates touch swipe navigation across visible tabs... |
...
| File | LOC |
|---|---|
| [src/components/StemMixer.tsx](../../src/components/StemMixer.tsx) | 7.2k |
