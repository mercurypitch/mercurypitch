...
| `keyboard` | [useKeyboardShortcuts.ts](../../src/features/keyboard/useKeyboardShortcuts.ts) | 338 | useKeyboardShortcuts — global hotkeys, mounted once by App One document-level keydown listener for the whole app. |
