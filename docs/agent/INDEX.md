...
| `stem-mixer` | [useStemMixerLyricsController.ts](../../src/features/stem-mixer/useStemMixerLyricsController.ts) | 9.7k | StemMixer Lyrics Controller — lyrics/LRC gen/blocks state + actions |
