...
| `mirror` | [MirrorApp.tsx](../../src/features/mirror/MirrorApp.tsx) | 6.3k | Voice Mirror — the guided 3-task flow (spec §2). |
...
| `mirror` | [metrics.ts](../../src/lib/mirror/metrics.ts) | 2.4k | Voice Mirror — pure metrics over F0 frame streams. |
