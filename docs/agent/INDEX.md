...
| `community` | [ProfileView.tsx](../../src/features/community/ProfileView.tsx) | 431 | ProfileView — your voice, so far Lifted out of CommunityShare, where it was ~200 lines inside an 1100-line component and could not be loo... |
...
| [HomePage.tsx](../../src/pages/HomePage.tsx) | 459 | HomePage — the "today" landing surface One obvious next step: your streak (with forgiveness), today's generated 5–15 min session, this we... |
