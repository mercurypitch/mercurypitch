...
**Status:** reference — 2026-05-31 research roadmap. Guitar practice shipped (`src/features/guitar-practice/`, `src/pages/GuitarPage.tsx`); treat individual items as unverified against current code.
