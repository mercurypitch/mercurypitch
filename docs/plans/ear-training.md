...
| 2026-08-28 | Contour's stylus: the founder saw the pivoted arm's line and dot outside the drum on the answer screen. Replaced by a pen carriage on a rail inside the drum, nib straight down, so nothing about the pen slopes on the screen that asks which way the tone went; the mobile audit now checks every pen part sits inside the drum.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Founder's screenshot 2026-08-28. Bias risk, not just looks.                                                                                                               |
| 2026-08-28 | PR #404 merged as `cbf6c4de` (merge commit, phase SHAs kept) after a coverage pass (`07651e45`: Ear Lab lines 65% → 90%). The rest of the catalogue starts on `feat/ear-lab-catalogue`, one PR with stacked commits, planned in `docs/plans/ear-lab-follow-up.md`: Pulse, Echo + Span, Beat Hunt + Drift, Gravity + The Pull, Cadence + Bassline, Subdivide, sing mode for Echo/Span, In The Wild (own songs, three item types), the mixing desk (Colour, Weight, Critique on the user's song or the house loop), the Ear Path (milestones in the bench, no locking), then the OG entry page and the tab icon.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Founder's decisions of 2026-08-28; the naming clash between the rhythm spec and the catalogue is settled in the follow-up plan (the catalogue wins).                      |
