...
| Date | Decision |
| --- | --- |
| 2026-08-03 | **PR opened: [#404](https://github.com/mercurypitch/mercurypitch/pull/404)** — Phases 0-3 as one reviewable unit (54 files, +8961/-3, purely additive). Held open pending the hardware pass on Phases 2-3 (`docs/ear-lab-testing.md` §1, §2, §2b-2d, §3b); Phase 4 continues on `feat/ear-lab` behind it rather than on a second branch, so the habit surfaces land against a merged engine. |
