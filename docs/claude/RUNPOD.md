...
3. **Credit metering** (implemented; see `~/.dotfiles/personal/mercurypitch/archive-2026-07/plans/premium.md` (archived 2026-07-28)
...
- `process` and `DELETE /session` stay behind the existing app-JWT edge gate in
  ...
  a separate billing-layer concern — see `~/.dotfiles/personal/mercurypitch/archive-2026-07/plans/premium.md` (archived 2026-07-28).)
