...
4. **Walk the guided tours** (release gate — per CLAUDE.md this full walk
...
5. **Create the annotated tag** on `main`'s latest commit:
...
6. **Push the tag** (this triggers the prod deploy):
