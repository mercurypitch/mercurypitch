...
VALUES
  ('sup-fund', '2026-01-01T00:00:00.000Z', '2026-01-01T00:00:00.000Z', 'donation', 'Fund',
  ...
  ('sup-extras', '2026-01-01T00:00:00.000Z', '2026-01-01T00:00:00.000Z', 'donation', 'Extras',
   'Everything in Fund, plus the cosmetic and early-access extras.', NULL, NULL, 'eur', NULL, NULL, 'Popular', 21, 1, 90, 0,
   '["Everything in Fund","Mascot costumes (coming)","Custom backgrounds (coming)","Beta features before everyone else","Behind-the-scenes build insights"]'),

  ('sup-voice', '2026-01-01T00:00:00.000Z', '2026-01-01T00:00:00.000Z', 'donation', 'Voice',
   'Everything in Extras, plus a say in where MercuryPitch goes next.', NULL, NULL, 'eur', NULL, NULL, NULL, 22, 1, 180, 0,
   '["Everything in Extras","A say in what gets prioritized","Your bug reports jump the queue","Priority mail support"]'),
  ...
  ('sup-custom', '2026-01-01T00:00:00.000Z', '2026-01-01T00:00:00.000Z', 'donation', 'Other amount',
   ...
   '["Supporter badge on your profile","You choose the amount on the next screen"]');
