...
const SURFACE_BY_ID: Record<PremiumBackgroundId, BackgroundSurface> = {
  ...
  'karaoke-floating-orb': 'karaoke',
  'karaoke-nordic-amphitheatre': 'karaoke',
  'jam-skyline-penthouse': 'jam',
  'jam-nordic-wood': 'jam',
  'piano-manor-library': 'piano',
  'piano-parisian-salon': 'piano',
  'guitar-british-rock': 'guitar',
  'guitar-venice-beach': 'guitar',
  'guitar-alpine-lodge': 'guitar',
  'guitar-blues-barn': 'guitar',
  'guitar-high-tech-vault': 'guitar',
  'guitar-industrial-loft': 'guitar',
  'guitar-metal-sanctuary': 'guitar',
  'guitar-pedal-lab': 'guitar',
  'guitar-spanish-courtyard': 'guitar',
  'jam-boho-attic': 'jam',
  'jam-cyber-bunker': 'jam',
  'jam-indie-loft': 'jam',
  'jam-industrial-soundstage': 'jam',
  'jam-japanese-zen': 'jam',
  'jam-retro-analog': 'jam',
  'jam-space-observatory': 'jam',
  'karaoke-broadway-theater': 'karaoke',
  'karaoke-jazz-club': 'karaoke',
  'karaoke-nordic-amphitheater': 'karaoke',
  'karaoke-rooftop-skyline': 'karaoke',
  'karaoke-rustic-coffeehouse': 'karaoke',
  'karaoke-speakeasy-vault': 'karaoke',
  'karaoke-starlight-solarium': 'karaoke',
  'karaoke-synthwave-80s': 'karaoke',
  'piano-1950s-jazz-lounge': 'piano',
  'piano-acoustic-chamber': 'piano',
  'piano-alpine-villa': 'piano',
