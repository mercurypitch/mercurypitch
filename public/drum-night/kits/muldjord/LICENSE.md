# Muldjord — sample credits and licence

MuldjordKit recordings by **Lars Muldjord**, distributed by **DrumGizmo**.
SFZ mapping and FLAC conversion by **kinwie**. This bank uses the old
**MuldjordKit v1.0 SFZ edition**, not the current DrumGizmo v3 kit.

- [Pinned source and original creators' description](https://github.com/sfzinstruments/DrumGizmo.MuldjordKit/tree/fc165714974aa843125ce88597f341b31376e1d5)
- [Original upstream notice](UPSTREAM-README.txt)
...
links, supplied notices, and an indication of changes when redistributing. No
endorsement by the creators, DrumGizmo, or equipment manufacturers is implied.
The material is provided as-is, without warranties, as described in the licence.
