...
The scroll's first chart-component partition was rejected: UV/hard-normal seams do not define mechanical parts. A deliberate cut/cap derivative retains unaffected dense faces, UVs, ivory/gold appearance and etched detail, and closes the moving pieces. A separate planar glass inset now passes Blender optical review after rejecting warped relief. Contact certification and runtime export are next; neither this derivative nor the pure render adapter is presented as accepted game art. The rose/amethyst donor audit likewise finds one fused closed surface; their gold lattice must be preserved deliberately during crystal-body and shard preparation.
