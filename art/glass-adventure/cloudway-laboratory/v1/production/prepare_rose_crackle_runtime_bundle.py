#!/usr/bin/env python3
"""Derive the all-triangle 2K Meshopt Rose crackle delivery candidate."""
...
DELIVERY = load_module(
    "cloudway_rose_full_detail_delivery_bundle",
    HERE / "prepare_rose_crackle_runtime_delivery.py",
)
