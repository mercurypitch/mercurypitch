"""Archive the two already-submitted floating-museum Meshy tasks safely."""
...
ASSETS = {
    "conservatory": {
        "taskId": "01a0c42e-51f6-77d1-85d5-1167fe7e5324",
        "guide": "sources/conservatory-guide.png",
        "final": "meshy/conservatory-final.glb",
        "preRemesh": "meshy/conservatory-pre-remesh.glb",
    },
    "twin-connector": {
        "taskId": "01a0c42f-a362-7199-a2f8-50dc99efb112",
        "guide": "sources/twin-connector-guide-opaque.png",
        "final": "meshy/twin-connector-final.glb",
        "preRemesh": "meshy/twin-connector-pre-remesh.glb",
    },
}
...
def load_meshy_pipeline():
    ...
    spec = importlib.util.spec_from_file_location("journey_map_v6_meshy_pipeline", path)
...
def main() -> None:
    ...
    if set(task_rows) != set(ASSETS):
        raise RuntimeError("tasks.json does not contain the exact approved two-asset batch")
    ...
    for asset, expected in ASSETS.items():
        ...
        receipts[asset] = {
            "schema": 1,
            "provider": "Meshy",
            "assetId": f"floating-museum-{asset}-v6",
