...
export const SessionBrowser: Component<SessionBrowserProps> = (props) => {
  const [activeCategory, setActiveCategory] = createSignal<FilterCategory>('all');
  ...
  const categories: FilterCategory[] = ['all', 'vocal', 'instrumental', 'ear-training', 'general'];
            ...
            {(session) => (
              <div class="session-card">
                ...
                <div class="session-meta">
                  ...
                  <span class="session-item-count">{session.items.length} items</span>
                  <span class="session-duration">~{estimateDuration(session.items)}</span>
                </div>
                <button
