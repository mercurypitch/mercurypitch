  ...
  return (
    <div class="session-player">
      ...
      <div class="session-player-item">
        ...
        <span class="session-item-label">{currentItem()?.label ?? 'Loading...'}</span>
      </div>
      ...
      <div class="session-player-controls">
        <button class="ctrl-btn session-skip-btn" onClick={props.onSkip} title="Skip this item">
          Skip
        </button>
        <button class="ctrl-btn session-end-btn" onClick={props.onEnd} title="End session">
          End
        </button>
      </div>
    </div>
