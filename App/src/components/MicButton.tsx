  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" width="18" height="18">
        {props.active ? (
          // Mic on with indicator
          <>
            <rect x="9" y="2" width="6" height="11" rx="3" fill="currentColor" />
            <path d="M19 10a7 7 0 01-10 6.33V18a1 1 0 01-2 0v-1.67A7 7 0 015 10a7 7 0 007 7 1 1 0 010 2 9 9 0 009-9z" fill="currentColor" />
          ...
          <>
            ...
            <path d="M19 10a7 7 0 01-10 6.33V18a1 1 0 01-2 0v-1.67A7 7 0 015 10a7 7 0 007 7 1 1 0 010 2 9 9 0 009-9z" fill="currentColor" opacity="0.4" />
