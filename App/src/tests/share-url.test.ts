...
describe('encodeMelodyToURL', () => {
  it('encodes single note correctly', () => {
    const melody: MelodyItem[] = [
      { note: { midi: 60, name: 'C', octave: 4, freq: 261 }, startBeat: 0, duration: 2 },
    ];
  ...
  it('encodes multiple notes correctly', () => {
    const melody: MelodyItem[] = [
      { note: { midi: 60, name: 'C', octave: 4, freq: 261 }, startBeat: 0, duration: 2 },
      { note: { midi: 64, name: 'E', octave: 4, freq: 329 }, startBeat: 2, duration: 2 },
      { note: { midi: 67, name: 'G', octave: 4, freq: 392 }, startBeat: 4, duration: 2 },
    ];
    const result = encodeMelodyToURL(melody);
  ...
  it('handles fractional beat positions', () => {
    const melody: MelodyItem[] = [
      { note: { midi: 60, name: 'C', octave: 4, freq: 261 }, startBeat: 1.5, duration: 0.5 },
    ];
    const result = encodeMelodyToURL(melody);
...
describe('round-trip encoding/decoding', () => {
  it('preserves melody data through encode/decode cycle', () => {
    const original: MelodyItem[] = [
      { note: { midi: 60, name: 'C', octave: 4, freq: 261 }, startBeat: 0, duration: 2 },
      { note: { midi: 64, name: 'E', octave: 4, freq: 329 }, startBeat: 2, duration: 3 },
      { note: { midi: 67, name: 'G', octave: 4, freq: 392 }, startBeat: 5, duration: 1 },
    ];
