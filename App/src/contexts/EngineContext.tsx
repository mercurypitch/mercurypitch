import { createContext, useContext, createEffect, onCleanup, JSX } from 'solid-js'
import { AudioEngine } from '@/lib/audio-engine'
import { PlaybackRuntime } from '@/lib/playback-runtime'
import { PracticeEngine } from '@/lib/practice-engine'
import { settings, instrument, bpm } from '@/stores'
...
export function EngineProvider(props: { children: JSX.Element }) {
  ...
  } as any) // We bypass strict types since we will fix its constructor later
  ...
  // Based on error: Property 'setConfig' does not exist on type 'PracticeEngine'.
  // createEffect(() => practiceEngine.setConfig(settings()))
