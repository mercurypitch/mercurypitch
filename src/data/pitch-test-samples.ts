...
export const TEST_SAMPLES: TestSample[] = [
  {
    ...
    notes: [
      ...
      { name: 'G#4', frequency: 415.3, deviationCents: 0, description: 'G#4' },
      {
        name: 'A4',
        frequency: 440.0,
        deviationCents: 0,
        description: 'A4 (Reference)',
      },
    ...
    notes: [
      {
        ...
        frequency: 445.0,
        deviationCents: 50,
        description: '+50 cents sharp',
      },
      {
        name: '-50',
        frequency: 435.0,
        deviationCents: -50,
        description: '-50 cents flat',
      },
      {
        name: '+90',
        frequency: 466.16,
        deviationCents: 90,
        description: '+90 cents sharp',
      },
      {
        name: '-90',
        frequency: 415.3,
        deviationCents: -90,
        description: '-90 cents flat',
      },
      {
        name: '+100',
        frequency: 466.16,
        deviationCents: 100,
        description: '+100 cents sharp',
      },
      {
        name: '-100',
        frequency: 415.3,
        deviationCents: -100,
        description: '-100 cents flat',
      },
    ],
  },
  {
...
export const REGISTERED_ALGORITHMS: Array<{
  id: PitchAlgorithm
  name: string
  description: string
...
}> = [
  {
    ...
    name: 'YIN',
    description:
      'Yin algorithm using difference function and cumulative mean normalization. Good balance of accuracy and speed.',
  ...
  },
  {
    ...
    description:
      'Uses Normalized Square Difference Function (NSDF) with positive-going zero crossings for octave discrimination. Generally more accurate than YIN.',
  ...
  },
  {
    ...
    name: 'SwiftF0 ML',
    description:
      'ML-based pitch detection using SwiftF0 model. Best for noisy environments, but requires ONNX model and 16kHz sample rate.',
...
export const ALGORITHM_PERFORMANCE: Record<
  PitchAlgorithm,
  { avgTime: number; realtime: boolean }
> = {
...
export function getAllTestableAlgorithms(): PitchAlgorithm[] {
  return (['yin', 'mpm', 'swift'] as PitchAlgorithm[]).filter(
    (a: PitchAlgorithm) => ALGORITHM_PERFORMANCE[a] !== undefined,
  )
}
