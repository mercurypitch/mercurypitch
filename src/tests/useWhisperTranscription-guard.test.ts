...
// guard, error channel, cache purge and log labelling.
//
// WhisperService / resampleTo16kHz and the IndexedDB persistence
// are mocked; the flow under test is the hook's own chunk loop,
// offsetting, guard and status/error reporting.
// ============================================================

import type { MockInstance } from 'vitest'
import { afterEach, beforeEach, describe, expect, it, vi } from 'vitest'
import { useWhisperTranscription, WHISPER_HALLUCINATION_USER_MESSAGE, } from '@/lib/useWhisperTranscription'
