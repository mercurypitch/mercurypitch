...
export function snapshot(): ProgressPageSnapshot {
  return {
    ...
    cabinet: {
      available: true,
      summary: '1 of 2 badges and 1 of 2 achievements earned, 1 under way.',
      badgesLabel: '1 / 2',
      achievementsLabel: '1 / 2',
      badges: [
        {
          id: 'steady-return',
          title: 'Steady Return',
