...
import { IconExpand, IconMusic, IconMic } from '@/components/exercise-icons'
      ...
      <div class="exercise-canvas-area">
        {base.state().status === 'idle' && (
          <div class="exercise-idle-placeholder">
            <IconExpand size={48} />
            <p>Hold a note and swell your volume from soft to loud and back. Master pitch stability under dynamic change.</p>
            <span class="idle-hint">4 rounds · 8-second holds · Varying pitches</span>
          </div>
        )}
          ...
          <>
            <div class="mirror-melody-phase">
              <span classList={{ listen: phase() === 1, sing: phase() === 2 }}>
                {phase() === 1 ? <><IconMusic size={16} /> Listen to {midiToNoteName(currentMidi())}...</>
                  : <><IconMic size={16} /> Hold {midiToNoteName(currentMidi())} — swell!</>}
              </span>
            </div>
