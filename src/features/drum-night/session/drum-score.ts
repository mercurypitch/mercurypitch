...
import type { PercussionNotationVoice, PercussionNotehead, PercussionSeatAnchor, PercussionVoiceFamily, } from '@/lib/percussion-notation'
...
/** Compatibility names keep Drum Night consumers stable on the shared map. */
export type DrumVoiceFamily = PercussionVoiceFamily
export type DrumSeatAnchor = PercussionSeatAnchor
export type DrumNotehead = PercussionNotehead
export type DrumScoreVoice = PercussionNotationVoice

export const drumScoreVoiceForGmKey = percussionNotationForGmKey
