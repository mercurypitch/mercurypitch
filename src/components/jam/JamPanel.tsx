...
import { JamInputControl } from './JamInputControl'
          ...
          <div class={panelStyles.mainArea}>
            ...
            >
              ...
              >
                ...
                {/* What this device is sending, and whether it is. First
                    in the row on a phone (see .micBtn) -- it is the control
                    with a consequence, and the one people look for when
                    somebody says they can hear the room.

                    Was a bare microphone toggle, which named the wrong
                    thing: it carries whichever input is selected, and for a
                    guitarist that is a DI through an interface and not a
                    microphone at all. JamInputControl also puts the choice
                    one press away, because picking `instrument` turns echo
                    cancellation off and that is the setting that howls. */}
                <div class={panelStyles.micBtn}>
                  <JamInputControl />
                </div>
