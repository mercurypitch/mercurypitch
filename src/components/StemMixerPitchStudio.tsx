...
export const StemMixerPitchStudio: Component<StemMixerPitchStudioProps> = (
  ...
  return (
    <PitchStageShell
      ...
      sidecarAriaLabel="Selected note inspector"
      sidecar={
        <>
          ...
          <Show
            ...
            fallback={
              <div class={styles.emptySelection}>
                ...
                <p>
                  Click an orange note to inspect it. Drag its center to move
                  and retune; drag either edge to change its timing.
                </p>
              </div>
            }
          >
