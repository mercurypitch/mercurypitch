  ...
  return (
    <div class={styles.libraryTab}>
                        ...
                        <span class={styles.pillTags}>
                          ...
                          {item.melodyData !== undefined &&
                            ...
                            (item.melodyData.tags as string[]).length > 2 && (
                              <span class={[styles.pillTag, 'more'].join(' ')}>
                                +{(item.melodyData.tags as string[]).length - 2}
                              </span>
                            )}
                        </span>
      ...
      <Show when={hasActivePracticeSession()}>
        <div class={[styles.sessionItemsSection, 'practice-session'].join(' ')}>
      ...
      {/*<div class={[styles.recentSection, 'recent-items-section'].join(' ')}>*/}
      ...
      {/*                      <span class={[styles.recentTag, 'more'].join(' ')}>*/}
      {/*                        +{(item.data.tags as string[]).length - 2}*/}
      {/*                      </span>*/}
      {/*                    )}*/}
      {/*                </div>*/}
      ...
      <div class={styles.quickActions} data-testid="quick-actions">
        ...
        <button
          class={styles.quickActionBtn}
          data-testid="sessions-quick-btn"
