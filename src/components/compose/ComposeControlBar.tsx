...
import { IconClear, IconClock, IconLoopPoint, IconMetronome, IconPause, IconPlay, IconRecord, IconRepeat, IconShare, IconSpeed, IconStop, IconVolume, IconWave, } from '@/components/shared/control-bar/icons'
