...
export const IconBoltChallenge = () => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const IconKeyboardChallenge = () => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const IconFireChallenge = () => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const IconMusicChallenge = () => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const IconStarChallenge = () => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const IconRefreshSimple = () => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
const iconMap: Record<string, Component> = {
  ...
  fire: IconFireChallenge,
  rocket: IconRocket,
  guitar: IconGuitarChallenge,
  volume: IconVolume,
  bolt: IconBoltChallenge,
  stopwatch: IconStopwatch,
  eagle: IconEagle,
  target: IconTarget,
  diamond: IconDiamond,
  keyboard: IconKeyboardChallenge,
  moon: IconMoon,
  leaf: IconLeaf,
  music: IconMusicChallenge,
  crown: IconCrown,
  sparkle: IconSparkle,
  paper: IconPaper,
  chart: IconChart,
  star: IconStarChallenge,
  badge: IconBadge,
  lock: IconLockSimple,
  filter: IconFilter,
  gear: IconGear,
