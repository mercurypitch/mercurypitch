...
export class WhisperService {
  ...
  private messageId = 0
  private resolves = new Map<number, (val: { text: string; chunks: WhisperSegment[] }) => void>()
  ...
  async transcribe(audioData: Float32Array): Promise<{ text: string; chunks: WhisperSegment[] }> {
