...
export const GUITAR_STRINGS: TestFrequency[] = [
  { frequency: 82.41, expectedNote: 'E2', expectedFreq: 82.41, expectedMidi: 41, expectedCents: 0 },
  { frequency: 110.00, expectedNote: 'A2', expectedFreq: 110.00, expectedMidi: 45, expectedCents: 0 },
...
export const COMMON_INTERVALS: TestFrequency[] = [
  { frequency: 277.18, expectedNote: 'C#4', expectedFreq: 277.18, expectedMidi: 61, expectedCents: 100 },
  { frequency: 311.13, expectedNote: 'D#4', expectedFreq: 311.13, expectedMidi: 63, expectedCents: 200 },
  { frequency: 349.23, expectedNote: 'F4', expectedFreq: 349.23, expectedMidi: 65, expectedCents: 500 },
  { frequency: 392.00, expectedNote: 'G4', expectedFreq: 392.00, expectedMidi: 67, expectedCents: 700 },
  { frequency: 440.00, expectedNote: 'A4', expectedFreq: 440.00, expectedMidi: 69, expectedCents: 700 },
  { frequency: 493.88, expectedNote: 'B4', expectedFreq: 493.88, expectedMidi: 71, expectedCents: 1100 },
]
...
export const OCTAVE_JUMPS: TestFrequency[] = [
  ...
  { frequency: 110.00, expectedNote: 'A3', expectedFreq: 110.00, expectedMidi: 57, expectedCents: 1200 },
  { frequency: 220.00, expectedNote: 'A4', expectedFreq: 220.00, expectedMidi: 69, expectedCents: 1200 },
  { frequency: 440.00, expectedNote: 'A5', expectedFreq: 440.00, expectedMidi: 81, expectedCents: 1200 },
  { frequency: 880.00, expectedNote: 'A6', expectedFreq: 880.00, expectedMidi: 93, expectedCents: 1200 },
]

// Extended range test (MIDI 40-100)
export const EXTENDED_RANGE: TestFrequency[] = Array.from({ length: 61 }, (_, i) => {
  const midi = 40 + i
