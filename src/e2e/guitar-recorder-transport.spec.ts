...
const RECORDING_ID = 'e2e-recorder-transport'
const SECOND_RECORDING_ID = `${RECORDING_ID}-second`
const DURATION = 12

async function enterRecording(page: Page, second = false): Promise<Locator> {
