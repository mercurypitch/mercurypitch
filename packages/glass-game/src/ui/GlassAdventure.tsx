    ...
    >
      <div
        ...
        onWheel={(event) => {
          ...
          if (adventure.paused() || adventure.tutorial()) return
      ...
      <Show when={!adventure.ready() && adventure.error() === null}>
        <div class={styles.loading} role="status">
          <span class={styles.loadingGem} />
      ...
      <Show when={adventure.paused() && !adventure.tutorial()}>
        <div class={styles.scrim}>
          ...
          >
            ...
            <Show
              when={
                adventure.audioPreferences() || adventure.narrationPreferences()
              }
            >
