...
| Module | Answers |
| --- | --- |
| `input-device` | *Which* input, remembered, and still valid |
...
cross-tab lock, the error taxonomy. This package owns the *choice* of
...
- **MercuryPitch** — not yet. Its `AudioDeviceSettings` predates this and
  is the better UI in some respects (input *and* output, `devicechange`
